...
SELECT SUBSTR(HIRE_DATE,0,2)
FROM EMPLOYEE;
//WHERE SUBSTR(SYSDATE,1,2) - SUBSTR(HIRE_DATE,1,2) >= 20; 
...
SELECT EMP_NAME, DEPT_CODE, SUBSTR(EMP_NO,1,6) 생년월일, SUBSTR(EMP_NO,1,2)-SYSDATE 나이
FROM EMPLOYEE;
