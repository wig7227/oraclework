/*
    ...
    (테이블에 이벤트가 발생했을때)자동으로 매번 실행할 내용을 미리 정의해 둘 수 있는 객체
    ...
    *트리거의 생성 구문
    ...
    BEFORE|FTER INSERT|UPDATE|DELETE ON 테이블명
    [FOR EACH ROW]
    [DECLARE
        변수 선언;]
    BEGIN
...
--EMPLOYEE테이블에 새로운 행이 INSERT될 때마다 자동으로 메시지 출력
...
INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
               VALUES('600','김나래','201023-2923231','J3',SYSDATE);

INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
               VALUES('601','김남제','201023-2923231','J5',SYSDATE);
...
INSERT INTO TB_PRODUCT VALUES(SEQ_PCODE.NEXTVAL,'아이폰17','APPLE',DEFAULT);
...
INSERT INTO TB_PROSALE
VALUES(SEQ_TCODE.NEXTVAL,200,SYSDATE,20,2500000);
...
/
INSERT INTO TB_PROSALE
VALUES(SEQ_TCODE.NEXTVAL,200,SYSDATE,20,3500000);
...
VALUES(SEQ_DCODE.NEXTVAL,200,SYSDATE,20,'입고');

INSERT INTO TB_PRODETAIL
VALUES(SEQ_DCODE.NEXTVAL,200,SYSDATE,10,'출고');