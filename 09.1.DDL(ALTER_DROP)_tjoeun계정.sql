...
DROP TABLE TB_STUDENT CASCADE CONSTRAINT;
DROP TABLE TB_PROFESSOR CASCADE CONSTRAINT;
DROP TABLE TB_GRADE CASCADE CONSTRAINT;
DROP TABLE TB_DEPARTMENT CASCADE CONSTRAINT;
DROP TABLE TB_CLASS_PROFESSOR CASCADE CONSTRAINT;
DROP TABLE TB_CLASS CASCADE CONSTRAINT;
