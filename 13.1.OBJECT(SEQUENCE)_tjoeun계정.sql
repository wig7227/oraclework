...
/*
    *시퀀스 사용
     ...
     시퀀스명.NEXTVAL: 시퀀스값에 일정하기 증사시켜서 발생된 값
                      현재시퀀스 값에서 INCREMENT BY한 값
                      시퀀스.CURRVAL + INCREMENT BY
*/
...
VALUES(SEQ_EID.NEXTVAL,'김남제','990101-1234123','J3',SYSDATE);

INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
VALUES(SEQ_EID.NEXTVAL,'김여제','990101-1234123','J3',SYSDATE);
