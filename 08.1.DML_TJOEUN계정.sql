...
INSERT INTO EMPLOYEE VALUES(300, '더조은', '9909024- 1122334', 'www@naver.com','01012341234'
                            ,'D2','J1',3500000,0.2,200,SYSDATE,NULL,'N');
...
CREATE TABLE SAL_DOWN
AS SELECT EMP_ID, EMP_NAME, SALARY, BONUS
    FROM EMPLOYEE
    WHERE 1=0;

--SALARY(NVL(BONUS,0)+1)    
INSERT ALL
WHEN SALARY > 3000000 THEN
    INTO SAL_UP VALUES(EMP_ID, EMP_NAME, SALARY, BONUS)
WHEN SALARY <= 3000000 THEN
    INTO SAL_DOWN VALUES(EMP_ID, EMP_NAME, SALARY, BONUS)    
...
SET SALARY = (SELECT SALARY
    ...
    BONUS = (SELECT SALARY
              FROM EMPLOYEE
              WHERE EMP_ID = '217')
WHERE EMP_NAME IN ('209','215','204');

--EMPLOYEE_COPY테이블의 ASIA 지역에서 근무하는 사원들의 보너스를 0.3으로 변경
