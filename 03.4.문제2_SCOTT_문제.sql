...
SELECT ENAME, SUBSTR(HIREDATE,1,2)년도,SUBSTR(HIREDATE,4,2)월
FROM EMP;
...
SELECT EMPNO, ENAME, HIREDATE, HIREDATE + 14240
FROM EMP;

--18. EMP테이블에서 입사일로부터 38년 이상 근무한 직원의 정보 조회
SELECT *
FROM EMP
WHERE 100 - SUBSTR(HIREDATE,3,2) + 25 >= 38;
