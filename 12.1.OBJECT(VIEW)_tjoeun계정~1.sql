/*
    *VIEW
    :SELECT문을 저장해둘 수 있는 객체
     > 실제테이블이 아님
     > 임시테이블(논리적인 테이블): 실제로 데이터가 담겨있지 않음
...
/*
    * 뷰 컬럼에 별칭 부여
    서브쿼리의 SELECT절에 함수식이나 산술연산식이 기술되어 있는 경우 반드시 별칭 부여
...
-- 실제 테이블에 (NULL, 인턴) 추가. JOB_CODE는 NOT NULL이기 때문에 오류
...
--INSERT
INSERT INTO VW_SAL VALUES(400, '김기인','991023-1122334','J1',3000000,36000000);
--오류
...
--INSERT
INSERT INTO VW_JOIN VALUES('400','이순신','981112-1234567','J1','총무부');
...
/*
    *VIEW 옵션
    ...
    [상세표현식] CREATE [OR_REPLACE[FORCE|NOFORECE]VIEW 뷰명
    AS 서브쿼리
    [WITH CHECK OPTION]
    [WITH READ ONLY]
